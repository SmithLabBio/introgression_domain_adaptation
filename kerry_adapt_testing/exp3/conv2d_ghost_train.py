...
source = Dataset("../ghost3/ghost3-1000.json", snps, multichannel=True)
validation = Dataset("../ghost3/ghost3-100.json", snps, multichannel=True)
...
test = Dataset("../ghost3/ghost3-test-100.json", snps, multichannel=True)
