...
source = Dataset("../secondaryContact3/secondaryContact3-1000.json", snps, sorting=euclidean, split=True, categorical=True)
target = Dataset("../ghost3/ghost3-100.json", snps, sorting=euclidean, split=True, categorical=True)
...
model = CDAN(
    ...
    metrics=["accuracy"],
    callbacks=[UpdateLambda(lambda_max=20)])
