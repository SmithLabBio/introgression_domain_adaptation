...
process train {
    ...
    /mnt/home/kc2824/popAI/kerry_evo/networks/train.py \
      ...
      --target_path ${params.sim_dir}/bear-secondary-contact-ghost-1-100-train-${data_type}.npz \
      --val_path    ${params.sim_dir}/bear-secondary-contact-ghost-1-100-val-${data_type}.npz \
...
workflow {
    ...
    max_lambda = channel.of(0.1, 1, 10, 20)
