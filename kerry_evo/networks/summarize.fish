...
set dir "/mnt/home/kc2824/fscratch/popai/bear3/"
./summarize.py "$dir/batch*" "test-epoch-50" "$dir/summary-mean.txt"
./summarize.py "$dir/batch*" "test-epoch-50" "$dir/summary-max.txt" --stat max
