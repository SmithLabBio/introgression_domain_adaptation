...
source = Dataset("../ghost3/ghost3-1000.json", snps, sorting=euclidean, split=True)
validation = Dataset("../ghost3/ghost3-100.json", snps, sorting=euclidean, split=True)
...
test = Dataset("../ghost3/ghost3-test-100.json", snps, sorting=euclidean, split=True)
