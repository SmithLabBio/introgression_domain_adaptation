...
train = Dataset("../secondaryContact3/secondaryContact3-1000.json", snps, multichannel=True)
validation = Dataset("secondaryContact3/secondaryContact3-val-100.json", snps, multichannel=True)
