...
#   $sim_dir/general-secondary-contact-ghost-1-1000-test.jso

echo "Bear Source:" 
./site_cnt.py SecondaryContact \
  $sim_dir/bear-secondary-contact-2-20000-train.json \
  $sim_dir/bear-secondary-contact-2-1000-train.json \
  $sim_dir/bear-secondary-contact-2-1000-test.json

# echo "Bear Target:"
# ./site_cnt.py GhostSecondaryContact \
#   $sim_dir/bear-secondary-contact-ghost-2-100-train.json \
#   $sim_dir/bear-secondary-contact-ghost-2-1000-test.json
