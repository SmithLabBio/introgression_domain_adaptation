...
results_original_test = pd.read_csv('results/original_test_roc_bgs.tsv', sep=",")
results_original_bgs = pd.read_csv('results/original_bgs_roc_bgs.tsv', sep=",")
results_cdan_test = pd.read_csv('results/cdan_test_roc_bgs.tsv', sep=",")
results_cdan_bgs = pd.read_csv('results/cdan_bgs_roc_bgs.tsv', sep=",")
...
plt.savefig("results/ROC_bgs.png")